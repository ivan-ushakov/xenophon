...
public class PianoView extends View {
    ...
    public interface OnKeyTouchListener {
        ...
        void onTouchUp(int midiCode);

        void onTouchDown(int midiCode);
    ...
    private void fireTouchUpListeners(int code) {
	if (onTouchListener != null) {
	    onTouchListener.onTouchUp(code);
	}
    }

    private void fireTouchDownListeners(int code) {
	if (onTouchListener != null) {
	    onTouchListener.onTouchDown(code);
	}
    }
	...
	public boolean onDown(MotionEvent e) {
	    ...
	    if (keyboard.touchItem(e.getX() / scaleX + xOffset, e.getY())) {
            fireTouchDownListeners(keyboard.getTouchedCode());
            invalidate();
	    }
	...
	public boolean onSingleTapUp(MotionEvent e) {
	    fireTouchUpListeners(keyboard.getTouchedCode());
